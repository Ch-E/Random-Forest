# -*- coding: utf-8 -*-
"""
Created on Sat Sep 14 08:00:44 2019
...
#best_tree = best_fit(RFtree, X_train, y_train)

# Output:
# The best parameters are {'max_depth': 14, 'max_features': None, 'max_leaf_nodes': None,
...
cross_val_prediction = cross_val_predict(RFtree, X_train, y_train, cv=5)

print("\n---------------------------------")
print("5-FOLD CROSS-VALIDATION")
print("---------------------------------")
print("Cross-validation score (R2): {}".format(cross_val_score(RFtree, X_train, y_train, cv=5)))
...
# 1. MEA = 0.12
# 2. Using best parameters for RandomForestRegressor: MEA = 0.07627555970856581
# 3. Feature selection: MEA = 0.0696620033244423
# 4. Outlier removal: MEA = 0.0696620033244423
