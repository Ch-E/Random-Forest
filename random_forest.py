...
RFtree = RandomForestRegressor(random_state=101, criterion="mse", max_depth=14, max_features=None,
                               max_leaf_nodes=None, min_samples_leaf=4, min_samples_split=14)
...
#best parameters
#{'max_depth': 14, 'max_features': None, 'max_leaf_nodes': None, 'min_samples_leaf': 4, 'min_samples_split': 14}
#MEA=0.07627555970856581

#feature selection
#MEA=0.0696620033244423
